...
parser.add_argument("--data_dir", default='/workspace/Data/genres_original/',type=str)
parser.add_argument("--store_dir", default='/workspace/datasets',type=str)
...
if __name__=="__main__":
 ...
 for _class in class_names:
  ...
  training_audios.extend(class_audio[:int(len(class_audio)*3/5)])
  validation_audios.extend(class_audio[int(len(class_audio)*3/5):int(len(class_audio)*4/5)])
  test_audios.extend(class_audio[int(len(class_audio)*4/5):])
 print(len(training_audios),len(validation_audios),len(test_audios))
 ...
 with open("{}test128mel1.pkl".format(args.store_dir),"wb") as handler:
